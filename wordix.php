...
/**
 * Ingresa la palabra wordix jugada y el numero de intentos que fueron necesarios para que el usuario la adivine. Calcula y retorna el monto de puntos obtenidos
 * @param STRING $palabraWordix
